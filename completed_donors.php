...
<body id="body-pd">
    ...
    <?php if(!$count)
        { ?>
            <br><h3 class="text-center" > You don't have not any Completed Donations </h3>
            <br>
            <?php }else{  ?>   
    <div class="row">
            <div class="col m-auto">
            <h3  style="padding-left:25px; color:Blue">Hello admin, Your Completed Donation Details are</h3><br> <br>             
