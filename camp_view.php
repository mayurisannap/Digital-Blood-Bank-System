...
$_SESSION['bid']=$bid;
$status="Active";
$query = " select * from camp2 where bid= '".$bid."' && status= '".$status."' ";  
...
<body id="body-pd">
	...
	<div class="container w-100 m-auto">
        ...
        <?php if(!$count)
        { ?>
            <h3 class="text-center" > You have not registered any Active Camps </h3>
            <br><h4 class="text-center">To Add Camp click on Add button below </h4>
            <?php }else{  ?>             
         <h3 class="text-center" >Your Active Camps are..</h3>
         <?php }?>
        ...
        <div class="row">
            <div class="col m-auto">
                <div class="card mt-5">
                    ...
                    <table class="table table-bordered">
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><button class="btn btn-primary" ><a class="text-white" href="deactive.php?id=<?php echo $ID ?> ">Deactivate</a></button>
                                    <td><a href="camp_donor_registration.php"><ion-icon name="chevron-forward-outline"></ion-icon></a></td>
                                </td>
                                </tr>        
                        <?php 
                                }  
                    ...
                    <button class="btn btn-primary" name="submit"><a class="text-white" href="camp.php?id=<?php echo $bid ?> ">Add Camp Here</a></button>
                </div>
            </div>
        </div>			
		</form>
