...
<body id="body-pd">
    ...
    <?php if(!$count)
        { ?>
            <br><h3 class="text-center" > You don't have not any approved request </h3>
            <br>
            <?php }else{  ?>  
    <div class="row">
            <div class="col m-auto">
            <h2  style="padding-left:15px; color:Blue;">Hello Admin, Manage your Approved Donation Requests from here..</h2><br> <br>             
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><button class="btn btn-primary" ><a class="text-white" href="complete.php?no=<?php echo $SrNo?>">Complete</button>
                                    <button class="btn btn-primary" style="background-color:red;"><a class="text-white"  href="unsuccessful.php?no=<?php echo $SrNo?>">Unsuceesful</button>
                                    </td>
                                </tr>        
                        <?php 
                                }  
