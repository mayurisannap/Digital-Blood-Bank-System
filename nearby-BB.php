  ...
  <div class="container">
    <div class="row mt-4">
      <div class="col-md-8 mx-auto bg-light rounded p-4">
        <h5 class="text-center font-weight-bold">Blood Banks Near You!</h5>
        <hr class="my-1">
        <h5 class="text-center text-secondary">Select your state and city</h5>
        <form action="bloodbanks-db.php" method="post" class="p-3">
