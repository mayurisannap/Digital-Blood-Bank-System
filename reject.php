   ...
   // if(isset($_POST['update']) )
    {
        ...
        if($result)
        {
            ...
            $mail->Subject = 'Rejected for Blood Donation Request';
            $mail->Body ="Hello $name.<br>
            &emsp; &emsp;   Your request for blood donation in $bname is rejected.<br>
                    You can send request on another date. <br>
                    Thank you,<br><br>
                    Best Regards,<br>
                    Digital Blood Bank";
            ...
            if($mail->send()){
                $_SESSION['status']="Rejected successfully and mail is sent";
                $_SESSION['status_code']="success";
                header("location:pending.php?id=$bid");
            }
            else{
                $_SESSION['status']="Rejected but Fail to send mail";
